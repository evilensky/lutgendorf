...
ActiveRecord::Schema.define(version: 20140403160607) do
  ...
  create_table "listenings", force: true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.boolean  "self_guided",                 default: false
  end
  ...
  create_table "participants", force: true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.datetime "study_start_date"
    t.string   "first_name"
    t.string   "last_name"
    t.string   "study_identification"
  end
  ...
  create_table "webexes", force: true do |t|
    t.string   "url"
